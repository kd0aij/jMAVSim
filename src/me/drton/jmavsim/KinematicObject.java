 ...
 * A KinematicObject has 3D position, velocity and acceleration, plus a rotation (orientation) and rotationRate.
 * This class has no methods which alter those state variables; KinematicObjects have fixed state trajectories.
 */
public abstract class KinematicObject extends WorldObject {
    ...
    @Override
    // this method updates only the TransformGroup (graphic state), physical state is updated by ???
