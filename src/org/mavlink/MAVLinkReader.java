/**
 * $Id: MAVLinkReader.java 690 2013-04-03 08:33:52Z ghelle $
 * $Date: 2013-04-03 10:33:52 +0200 (mer., 03 avr. 2013) $
 *
 * ======================================================
...
public class MAVLinkReader {
    ...
    protected boolean readEndMessage() throws IOException {
        ...
        if ((crcl == crcLow) && (crch == crcHigh)) {
            ...
            me.drton.jmavsim.Simulator.logger.log(Level.WARNING, 
                    "ERROR mavlink CRC16-CCITT compute= " + Integer.toHexString(crc) + "  expected : "
